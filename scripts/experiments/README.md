...
|--------|-------------|-------|
| `run-experiments.ts` | Run all experiments | `npm run experiments` |
| `run-topic-continuity.ts` | Topic continuity experiment | `npm run topic-continuity` |
| `run-edge-decay-sim.ts` | Edge decay simulation | `npm run edge-decay-sim` |
| `run-edge-decay-experiments.ts` | Edge decay experiments | `npm run edge-decay-experiments` |
