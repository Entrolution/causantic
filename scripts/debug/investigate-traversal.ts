...
async function main() {
  ...
  console.log(
    '  Total chunks from backward:      ' +
      totalBackward +
      ' (' +
      ((totalBackward / totalVector) * 100).toFixed(1) +
      '% increase)',
  );
  console.log(
    '  Total chunks from forward:       ' +
      totalForward +
      ' (' +
      ((totalForward / totalVector) * 100).toFixed(1) +
      '% increase)',
  );
  console.log(
    '  Combined graph contribution:     ' +
      (totalBackward + totalForward) +
      ' (' +
      (((totalBackward + totalForward) / totalVector) * 100).toFixed(1) +
      '% increase)',
  );
  console.log('');
